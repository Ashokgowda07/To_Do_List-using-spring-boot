...
public class TodoListController {
    ...
    @GetMapping("/api/todolist") //, method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
     ...
     * HTTP POST NEW ONE
     */
    @PostMapping("/api/todolist") //, method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping("/api/todolist") // method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping("/api/todolist/{id}") //, method = RequestMethod.DELETE)
